...
const SignUpOrganization: React.FC<NativeStackScreenProps<SignUpStackParamList, "SignUpOrganization">> = ({
  ...
  const validate = () => {
    ...
    navigate("SignUpConfirm", { name, email, password, sex, birth, phone, organization: "시광교회" });
  };
  ...
  return (
    ...
    >
      <Container>
        ...
        <Wrap>
          <AskText>소속되어 있는 단체를 알려주세요.</AskText>
          <SubText>{`현재는 시광교회 교인을 대상으로 사용되는 앱입니다.\n시광교회 교인만 가입 가능합니다.`}</SubText>
          <FieldContentView>
            <FieldContentLine>
            ...
            <FieldContentLine>
              <ChoiceButton
                ...
                activeOpacity={0.5}
              >
                <FieldContentText>{`기타 단체`}</FieldContentText>
