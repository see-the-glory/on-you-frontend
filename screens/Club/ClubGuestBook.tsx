...
import { ActivityIndicator, Alert, Keyboard, KeyboardAvoidingView, LayoutChangeEvent, Platform, StatusBar, TouchableOpacity, useWindowDimensions, View } from "react-native";
...
const ClubGuestBook: React.FC<NativeStackScreenProps<any, "ClubGuestBook">> = ({
  route: {
