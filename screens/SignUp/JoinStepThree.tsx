    ...
    >
      <Container>
        ...
        <Wrap>
          ...
          <Input placeholder="example@email.com" placeholderTextColor={"#B0B0B0"} autoCorrect={false} onChangeText={(email: string) => setEmail(email)} error={email !== "" && !emailReg.test(email)} />
        ...
        <BottomButton onPress={goToNext} disabled={!emailReg.test(email)} title={"다음"} />
      </Container>
    </TouchableWithoutFeedback>
  );
};
