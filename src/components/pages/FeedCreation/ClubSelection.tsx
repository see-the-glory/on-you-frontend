...
import { ActivityIndicator, FlatList, Platform, StatusBar, TouchableOpacity } from "react-native";
...
const ClubSelection: React.FC<NativeStackScreenProps<FeedStackParamList, "ClubSelection">> = ({ navigation: { navigate, setOptions, goBack } }) => {
