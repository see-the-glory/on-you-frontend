...
import { ActivityIndicator, useWindowDimensions, Animated, FlatList, DeviceEventEmitter, TouchableWithoutFeedback, View, Alert, StatusBar, Platform } from "react-native";
import styled from "styled-components/native";
import { Feather, Ionicons } from "@expo/vector-icons";
import { BaseResponse, Club, ClubApi, ErrorResponse, GuestComment, GuestCommentDeletionRequest, GuestCommentResponse, Member, RefinedSchedule } from "api";
...
const ClubHome: React.FC<NativeStackScreenProps<any, "ClubHome"> & ClubHomeParamList> = ({
